...
namespace StripeIntegration\Payments\Test\Integration\Frontend\RedirectFlow\AuthorizeCapture\ConfigurableSubscription;
...
class AvailabilityTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function EUMethodProvider()
    {
        return [
            [
                "cartType" => "ConfigurableSubscription",
